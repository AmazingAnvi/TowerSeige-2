...
function draw() {
  ...
  textSize(20);
  fill("lightyellow");
  text("Drag the Ball and Release it, to launch it towards the blocks",170, 30);
  text("The object of the game is to destory the blocks!", 220, 60);
